 ...
 * 
 */
@WebServiceClient(name = "MovieServiceImplService", targetNamespace = "http://wsserver.lab7.sichyuriyy.at.gmail.com/", wsdlLocation = "http://localhost:8081/Lab7-0.0.1-SNAPSHOT/MovieServiceImpl?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MOVIESERVICEIMPLSERVICE_QNAME = new QName("http://wsserver.lab7.sichyuriyy.at.gmail.com/", "MovieServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8081/Lab7-0.0.1-SNAPSHOT/MovieServiceImpl?wsdl");
    ...
    public MovieWS getMovieServiceImplPort() {
        return super.getPort(new QName("http://wsserver.lab7.sichyuriyy.at.gmail.com/", "MovieServiceImplPort"), MovieWS.class);
    }
     ...
     */
    @WebEndpoint(name = "MovieServiceImplPort")
    public MovieWS getMovieServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://wsserver.lab7.sichyuriyy.at.gmail.com/", "MovieServiceImplPort"), MovieWS.class, features);
    }
